...
public class AuthController implements AuthApi {
    ...
    @Override
    @PostMapping("/refresh")
    public ResponseEntity<JwtResponse> getNewAccessToken(@Valid RefreshJwtRequest refreshJwtRequest) {
        return new ResponseEntity<>(authenticationService.getNewAccessToken(refreshJwtRequest), HttpStatus.OK);
    }
}
